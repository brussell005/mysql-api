...
exports.DELETE_ITEM = (userId, itemId) =>
  `DELETE FROM items WHERE user_id = ${userId} AND inventory_id = ${itemId}`;

exports.GET_QUANTITY = (userId, item_name) =>
  `SELECT quantity FROM items WHERE user_id = ${userId} AND item-name = ${item_name}`;
